...
[], b = [], o = f[0] === '^', c = o ? 1 : 0, i = f.length; c < i; ++c) {
                ...
                if (/\\[bdsw]/i.test(j)) {
                    ...
                    c + 2 < i && f[c + 1] === '-' ? (d = m(f[c + 2]), c += 2) : d = j; b.push([
                        j,
                        d
...
(j = Number(j.substring(1))) && j <= i && (f[c] = `\\${d[i]}`);
            } for (i = c = 0; c < b; ++c) {
                f[c] === '^' && f[c + 1] !== '^' && (f[c] = '');
            } if (a.ignoreCase && s) {
                for (c = 0; c < b; ++c) {
        ...
        a.currentStyle ? l = a.currentStyle.whiteSpace : window.getComputedStyle && (l = document.defaultView.getComputedStyle(a, q).getPropertyValue('white-space')); var p = l && l.substring(0, 3) === 'pre';
...
'string') {
        ...
        (function () {
            for (var e = a.concat(m),
                ...
                }r = r[1]; n = String(r); p.hasOwnProperty(n) || (l.push(r), p[n] = q);
            }l.push(/[\S\s]/); y = L(l);
        }()); var t = m.length;
        ...
        function e (a) {
            ...
            function b (a, d) {
                ...
                if (f) {
                    ...
                    f.appendChild(e); for (let h = g; h; h = g) {
        ...
        a.currentStyle ? l = a.currentStyle.whiteSpace : window.getComputedStyle && (l = s.defaultView.getComputedStyle(a, q).getPropertyValue('white-space')); var p = l && l.substring(0, 3) === 'pre';

        for (l = s.createElement('LI'); a.firstChild;) {
            l.appendChild(a.firstChild);
        } for (var d = [l], g = 0; g < d.length; ++g) {
            e(d[g]);
        }m === (m | 0) && d[0].setAttribute(
            'value',
            m
        ); const r = s.createElement('OL');

        r.className = 'linenums'; for (var n = Math.max(0, m - 1 | 0) || 0, g = 0, z = d.length; g < z; ++g) {
...
a.g;
        ...
        try {
            ...
            a.a = h; a.c = e.c; a.d = 0; C(m, h)(a); var k = (/\bMSIE\b/).test(navigator.userAgent),
                m = /\n/g,
                t = a.a,
                s = t.length,
                e = 0,
...
j; let u = i.ownerDocument,
    ...
    k(O, ['default-code']); k(
        ...
        'cyc',
        'm'
    ]); k(u({keywords: 'null,true,false'}), ['json']); k(u({
        keywords: H,
        hashComments: !0,
        cStyleComments: !0,
        verbatimStrings: !0,
    ...
    ]), ['regex']); window.prettyPrintOne = function (a, m, e) {
        const h = document.createElement('PRE');

        h.innerHTML = a; e && D(h, e); E({
            g: m,
            i: e,
            h
        });
...
!k) {
                    ...
                    }b || ((b = (b = n.className.match(/\blinenums\b(?::(\d+))?/)) ? b[1] && b[1].length ? Number(b[1]) : !0 : !1) && D(n, b), d = {
                        g: k,
                        h: n,
                        i: b
                    }, E(d));
